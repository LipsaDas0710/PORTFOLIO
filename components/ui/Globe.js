...
export function Globe({ globeConfig = {}, data = [] }) {
  ...
  const buildMaterial = () => {
    ...
    globeMaterial.color = new Color(defaultProps.globeColor || globeConfig.globeColor);
    globeMaterial.emissive = new Color(defaultProps.emissive || globeConfig.emissive);
  ...
  return (
    <>
      {/* render the ThreeGlobe instance via primitive to avoid extend() issues */}
      <primitive ref={globeRef} object={globe} />
    </>
  );
}
